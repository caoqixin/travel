...
export default function FlightSearch({
  ...
  useEffect(() => {
    ...
    // 直接调用onSearchRef.current，避免依赖immediateSearch函数
    onSearchRef.current({ destination, sortBy });
  }, [sortBy, destination]); // 移除immediateSearch依赖
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2 items-end">
                <Button
                  ...
                  disabled={loading}
                  className="px-6 py-3 h-10 lg:h-12 bg-blue-600 hover:bg-blue-700"
                >
                  {loading ? (
                    <>
                ...
                <Button
                  ...
                  variant="outline"
                  disabled={loading}
                  className="px-4 py-3 h-10 lg:h-12"
                >
            ...
            <div className="flex flex-wrap gap-2 lg:gap-3">
              {[
                ...
                <Button
                  ...
                  className="text-xs lg:text-sm h-7 lg:h-9 px-2 lg:px-4 border-gray-200 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 hover:scale-105"
                >
                  {city}
                </Button>
              ))}
